...
files = ('../skyrim_data/skyrim_mods_all.json','../oblivion_data/oblivion_mods_all.json','../morrowind_data/morrowind_mods_all.json',
         '../dragon_age_data/da/dragon_age_mods_all.json','dragon_age_data/da2/dragon_age_2_mods_all.json',
